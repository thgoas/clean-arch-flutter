...
import 'package:fin_ca/layers/data/repositories/get_one_group_repository_imp.dart';
import 'package:fin_ca/layers/data/sources/local/get_one_group_data_source_local.dart';
...
void main() {
  ...
  test('should return a GetDataSourceError when id not exist', () async {
    ...
    expect(result.fold((l) => l, (r) => r), isA<GetDataSourceError>());
  });
}
